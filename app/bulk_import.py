...
DRIVER_COLUMNS = [
    ...
    ImportColumn("backus_training_date", "Capacitación Backus — fecha", kind="date", width=20),
    ImportColumn("backus_training_expiry", "Capacitación Backus — vencimiento", kind="date", width=22),
    ImportColumn("dds_date", "DDS — fecha", kind="date", width=14),
    ImportColumn("dds_expiry", "DDS — vencimiento", kind="date", width=16),
